		...
		<>
			{announcements?.map(({ start, end, content, cta, _id }) => (
				<Scheduler start={start} end={end} key={_id}>
					<aside
						className="hidden dark md:flex border-b-1 border-divider bg-background px-6 py-2 backdrop-blur-xl sm:px-3.5">
						<div className='container flex flex-wrap justify-between gap-y-2 w-full items-center gap-x-6'>
